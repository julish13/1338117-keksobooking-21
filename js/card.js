...
(function () {
  ...
  let fillCardBoxFields = (cardBox, advertData, advertDataField, fieldSelector) => {
  ...
  let checkField = (cardBox, advertDataField, fieldSelector, cb) => {
  ...
  let onPinEnterPressOpenPopup = (evt) => {
